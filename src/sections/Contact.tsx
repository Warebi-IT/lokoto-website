...
const Contact = () => {
    ...
    const ctx = gsap.context(() => {
      gsap.fromTo(
        ...
        { y: 80, scale: 0.98, opacity: 0 },
        {
          ...
          scrollTrigger: { trigger: ctaPanelRef.current, start: "top 80%", toggleActions: "play none none reverse" },
        },
      );
      gsap.fromTo(
        formRef.current,
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="relative bg-[#E9EBE9] dark:bg-[#0F1210] py-20 lg:py-32 z-[110]"
    >
      <div className="px-6 lg:px-[7vw]">
        ...
        >
          ...
          <h2 className="text-[32px] sm:text-[44px] lg:text-[56px] font-extrabold leading-[1.0] tracking-[-0.02em] text-[#111311] mb-4">
            Soyez parmi<br className="hidden sm:block" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-16">
          ...
          <div
            ref={formRef}
            id="contact-form"
            className="bg-white dark:bg-[#1C201C] rounded-[28px] p-6 lg:p-8 shadow-card"
          >
            {status === 'success' ? (
              <div className="flex flex-col items-center justify-center text-center py-12 gap-4">
                ...
                <h3 className="text-xl font-bold text-lokoto-gray dark:text-[#EDEFED]">Message envoyé !</h3>
                <p className="text-sm text-lokoto-gray-medium dark:text-[#8A928A] max-w-xs">
              ...
              <>
                <h3 className="text-2xl font-bold text-lokoto-gray dark:text-[#EDEFED] mb-2">
                  Rejoindre la liste d'attente
                </h3>
                <p className="text-sm text-lokoto-gray-medium dark:text-[#8A928A] mb-6">
                ...
                <form onSubmit={handleSubmit} name="contact" data-netlify="true" className="space-y-5">
                  ...
                  <div>
                    <Label htmlFor="name" className="text-lokoto-gray dark:text-[#EDEFED] mb-2 block">
                      Nom complet
                    </Label>
                    <Input
                      id="name"
                      ...
                      className="rounded-xl border-black/10 dark:border-white/10 dark:bg-[#111413] dark:text-[#EDEFED] focus:border-lokoto-green focus:ring-lokoto-green"
                      required
                    />
                  </div>
                  <div>
                    <Label htmlFor="email" className="text-lokoto-gray dark:text-[#EDEFED] mb-2 block">
                      Email
                    </Label>
                    <Input
                      id="email"
                  ...
                  <div>
                    <Label htmlFor="phone" className="text-lokoto-gray dark:text-[#EDEFED] mb-2 block">
                      WhatsApp / Téléphone
                    </Label>
                    <Input
                      id="phone"
                      ...
                      className={`rounded-xl border-black/10 dark:border-white/10 dark:bg-[#111413] dark:text-[#EDEFED] focus:border-lokoto-green focus:ring-lokoto-green ${phoneError ? "border-red-400 focus:border-red-400 focus:ring-red-400" : ""}`}
                      required
                    />
                    {phoneError && (
                  ...
                  <div>
                    <Label htmlFor="message" className="text-lokoto-gray dark:text-[#EDEFED] mb-2 block">
                    ...
                    <Textarea
                      ...
                      className="rounded-xl border-black/10 dark:border-white/10 dark:bg-[#111413] dark:text-[#EDEFED] focus:border-lokoto-green focus:ring-lokoto-green min-h-[100px]"
                    />
                  </div>
                  <button
                    type="submit"
                  ...
                  <p className="text-xs text-center text-lokoto-gray-medium dark:text-[#8A928A]">
          ...
          <div className="flex flex-col justify-center">
            <h3 className="text-2xl font-bold text-lokoto-gray dark:text-[#EDEFED] mb-6">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-sm text-lokoto-gray-medium dark:text-[#8A928A]">Email</div>
                  <a
                    href="mailto:moussamarega8@gmail.com"
                    className="text-lg font-semibold text-lokoto-gray dark:text-[#EDEFED] hover:text-lokoto-green transition-colors"
                  >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-sm text-lokoto-gray-medium dark:text-[#8A928A]">Téléphone</div>
                  <a
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-sm text-lokoto-gray-medium dark:text-[#8A928A]">WhatsApp</div>
                  <a
        ...
        {/* Footer */}
        <div ref={footerRef} className="border-t border-black/10 dark:border-white/10 pt-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="text-2xl font-bold text-lokoto-gray dark:text-[#EDEFED]">Lokoto</div>

            <div className="flex flex-wrap justify-center gap-6">
              <button
                onClick={() => scrollToSection("features")}
                className="text-sm text-lokoto-gray-medium dark:text-[#8A928A] hover:text-lokoto-green transition-colors"
              >
                Fonctionnalités
              </button>
              <button
            ...
            <div className="text-sm text-lokoto-gray-medium dark:text-[#8A928A]">
