...
const FeatureAccounting = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="features"
      className="relative flex flex-col md:block w-screen md:h-screen md:overflow-hidden bg-[#F6F7F6] dark:bg-[#111413] z-[60]"
    >
...
export default FeatureAccounting;
